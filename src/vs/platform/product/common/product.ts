...
// _HAYSTACK environment
else if (globalThis._HAYSTACK_PRODUCT_JSON && globalThis._HAYSTACK_PACKAGE_JSON) {
  // Obtain values from product.json and package.json-data
  product = globalThis._HAYSTACK_PRODUCT_JSON as unknown as IProductConfiguration
  ...
  if (!product.version) {
    const pkg = globalThis._HAYSTACK_PACKAGE_JSON as { version: string }
...
// Web environment or unknown
  ...
  if (Object.keys(product).length === 0) {
    Object.assign(product, {
      version: "1.90.0-dev",
      nameShort: "Haystack Editor Dev",
      nameLong: "Haystack Editor Dev",
