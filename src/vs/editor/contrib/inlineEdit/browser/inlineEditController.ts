...
export class InlineEditWidget implements IDisposable {
  constructor(
    public readonly widget: GhostTextWidget,
    public readonly edit: IInlineEdit,
  ) {}
...
export class InlineEditController extends Disposable {
  ...
  public static readonly inlineEditVisibleContext = new RawContextKey<boolean>(
    InlineEditController.inlineEditVisibleKey,
    false,
  )
  private _isVisibleContext =
    InlineEditController.inlineEditVisibleContext.bindTo(this.contextKeyService)

  public static readonly cursorAtInlineEditKey = "cursorAtInlineEdit"
  public static readonly cursorAtInlineEditContext = new RawContextKey<boolean>(
    InlineEditController.cursorAtInlineEditKey,
    false,
  )
  ...
  private _currentEdit: ISettableObservable<InlineEditWidget | undefined> =
    this._register(disposableObservableValue(this, undefined))
  ...
  private readonly _backgroundColoring = observableFromEvent(
    this.editor.onDidChangeConfiguration,
    () => this.editor.getOption(EditorOption.inlineEdit).backgroundColoring,
  )
