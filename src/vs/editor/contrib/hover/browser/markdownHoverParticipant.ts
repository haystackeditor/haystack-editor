...
class MarkdownRenderedHoverParts extends Disposable {
  ...
  constructor(
    ...
    super()
    this._renderedHoverParts = this._renderHoverParts(
      hoverParts,
      hoverPartsContainer,
  ...
  private _renderHoverPart(
    ...
    const { renderedMarkdown, disposables } = this._renderMarkdownContent(
      hoverContents,
      onFinishedRendering,
    )
  ...
  private _renderHoverExpansionAction(
    ...
    const actionFunction = () =>
      this.updateMarkdownHoverPartVerbosityLevel(action)
  ...
  public async updateMarkdownHoverPartVerbosityLevel(
    ...
    if (
      !hoverRenderedPart ||
      !hoverRenderedPart.hoverSource?.supportsVerbosityAction(action)
    ) {
      return
    }
  ...
  private _replaceRenderedHoverPartAtIndex(
    index: number,
    renderedHoverPart: RenderedHoverPart,
  ): void {
