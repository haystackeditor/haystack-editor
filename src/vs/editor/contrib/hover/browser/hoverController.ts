...
export class HoverController extends Disposable implements IEditorContribution {
  ...
  private _shouldNotRecomputeCurrentHoverWidget(
    ...
    const isMouseOnStickyMarginHoverWidget = (
      mouseEvent: IEditorMouseEvent,
      isHoverSticky: boolean,
    ) => {
      const isMouseOnMarginHoverWidget =
        this._isMouseOnMarginHoverWidget(mouseEvent)
  ...
  private _reactToEditorMouseMove(
    ...
    const contentHoverShowsOrWillShow = this._tryShowHoverWidget(
      mouseEvent,
    ...
    const glyphWidgetShowsOrWillShow = this._tryShowHoverWidget(
      mouseEvent,
  ...
  public doesMarkdownHoverAtIndexSupportVerbosityAction(
    ...
    return this._getOrCreateContentWidget().doesMarkdownHoverAtIndexSupportVerbosityAction(
      index,
      action,
    )
  }
  ...
  public updateMarkdownHoverVerbosityLevel(
    ...
    this._getOrCreateContentWidget().updateMarkdownHoverVerbosityLevel(
      action,
      index,
      focus,
    )
