...
export class ContentHoverWidget extends ResizableContentWidget {
  ...
  public isMouseGettingCloser(posx: number, posy: number): boolean {
    ...
    if (
      distance >
      this._visibleData.closestMouseDistance + 4 /* tolerance of 4 pixels */
    ) {
  ...
  private _removeConstraintsRenderNormally(): void {
    ...
    this._resizableNode.domNode.style.width = "100%"
    // this._resizableNode.domNode.style.height = "100%"
    this._resizableNode.layout()
