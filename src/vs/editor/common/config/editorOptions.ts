 ...
 * @internal
 */
export type HaystackEditorOptions = Readonly<Required<IHaystackEditorOptions>>

class HaystackEditor extends BaseEditorOption<
  EditorOption.haystackEditor,
  IHaystackEditorOptions,
  HaystackEditorOptions
> {
  constructor() {
    const defaults: HaystackEditorOptions = {
      initialWidth: 800,
      copilotOptOut: true,
    ...
    super(EditorOption.haystackEditor, "haystackEditor", defaults, {
      "editor.haystackEditor.initialWidth": {
        type: "number",
        default: defaults.initialWidth,
        description: nls.localize(
          "editor.haystackEditor.initialWidth",
          "Determines the default width for a haystack editor.",
        ),
      },
      "editor.haystackEditor.copilotOptOut": {
        type: "boolean",
        default: defaults.copilotOptOut,
        description: nls.localize(
          "editor.haystackEditor.copilotOptOut",
          "Determines whether the user has opted out of Haystack's navigational copilot",
        ),
      },
      "editor.haystackEditor.hideCanvasDots": {
        type: "boolean",
        default: defaults.hideCanvasDots,
        description: nls.localize(
          "editor.haystackEditor.hideCanvasDots",
          "Determines whether the canvas should be showing equally-spaced dots",
        ),
      },
      "editor.haystackEditor.middleMouseClickToCloseEditors": {
        type: "boolean",
        default: defaults.middleMouseClickToCloseEditors,
        description: nls.localize(
          "editor.haystackEditor.middleMouseClickToCloseEditors",
          "Determines whether the middle mouse button should close editors when the user clicks on an editor header",
        ),
      },
      "editor.haystackEditor.enableSymbolAtFileSelection": {
        type: "boolean",
        default: defaults.enableSymbolAtFileSelection,
        description: nls.localize(
          "editor.haystackEditor.enableSymbolAtFileSelection",
  ...
  public validate(_input: any): HaystackEditorOptions {
    if (!_input || typeof _input !== "object") {
      return this.defaultValue
    }
    const input = _input as IHaystackEditorOptions
    return {
      initialWidth: EditorIntOption.clampedInt(
        input.initialWidth,
        this.defaultValue.initialWidth,
        1,
        5000,
      ),
      copilotOptOut: this.defaultValue.copilotOptOut,
      hideCanvasDots: this.defaultValue.hideCanvasDots,
      middleMouseClickToCloseEditors:
...
> {
  ...
  public validate(_input: any): InternalInlineEditOptions {
    ...
    return {
      ...
      keepOnBlur: boolean(input.keepOnBlur, this.defaultValue.keepOnBlur),
      backgroundColoring: boolean(
        input.backgroundColoring,
        this.defaultValue.backgroundColoring,
      ),
    }
  }
}
...
export const EditorOptions = {
  ...
  haystackEditor: register(new HaystackEditor()),
