...
class ObservableCodeEditor {
  ...
  public readonly model = observableFromEvent(
    this.editor.onDidChangeModel,
    () => this.editor.getModel(),
  )
  public readonly value = observableFromEvent(
    this.editor.onDidChangeModelContent,
    () => this.editor.getValue(),
  )
  public readonly valueIsEmpty = observableFromEvent(
    this.editor.onDidChangeModelContent,
    () => this.editor.getModel()?.getValueLength() === 0,
  )
  public readonly selections = observableFromEvent(
