    ...
    private _computeDesiredScrollTop(
      ...
      if (args.unit === EditorScroll_.Unit.Line) {
        ...
        const visibleViewRange =
          viewModel.getCompletelyVisibleViewRangeAtScrollTop(futureViewport.top)
    ...
    registerEditorCommand(
      new (class extends CoreEditorCommand<RevealLineCommandOptions> {
        ...
        public runCoreEditorCommand(
          ...
          console.log("MOTHER MARIKA", revealAt)
          if (revealLineArg.at) {
    ...
    registerEditorCommand(
      new (class extends CoreEditorCommand<SetSelectionCommandOptions> {
        ...
        public runCoreEditorCommand(
          ...
          viewModel.model.pushStackElement()
          viewModel.setCursorStates(args.source, CursorChangeReason.Explicit, [
            CursorState.fromModelSelection(
              args.selection,
              new CursorContext(
                viewModel.model,
                viewModel.getEditRange(),
