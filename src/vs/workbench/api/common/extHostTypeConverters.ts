        ...
        (subArr) =>
          ...
          subArr.every(
            (docRef) =>
              ...
              docRef.ranges.every((r: unknown) => r instanceof types.Range),
          ),
      )
    )
  }
...
export namespace TestCoverage {
  ...
  export function fromFile(
    ...
    return {
      ...
      testId:
        coverage instanceof types.FileCoverage && coverage.testItem
  ...
  export function to(
    ...
    switch (message.role) {
      case chatProvider.ChatMessageRole.System:
        return new types.LanguageModelChatMessage(
          <number>types.LanguageModelChatMessageRole.System,
          message.content,
        )
      case chatProvider.ChatMessageRole.User:
        return new types.LanguageModelChatMessage(
          <number>types.LanguageModelChatMessageRole.User,
          message.content,
        )
      case chatProvider.ChatMessageRole.Assistant:
        return new types.LanguageModelChatMessage(
          <number>types.LanguageModelChatMessageRole.Assistant,
          message.content,
        )
    }
  }
  ...
  export function from(
    ...
    switch (message.role as types.LanguageModelChatMessageRole) {
      case types.LanguageModelChatMessageRole.System:
        return {
          role: chatProvider.ChatMessageRole.System,
          content: message.content,
        }
      case types.LanguageModelChatMessageRole.User:
        return {
          role: chatProvider.ChatMessageRole.User,
          content: message.content,
        }
      case types.LanguageModelChatMessageRole.Assistant:
        return {
          role: chatProvider.ChatMessageRole.Assistant,
          content: message.content,
        }
    }
  }
