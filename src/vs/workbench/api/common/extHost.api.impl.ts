...
export function createApiFactoryAndRegisterActors(
  ...
  return function (
    ...
    const chat: typeof vscode.chat = {
      ...
      attachContext(
        name: string,
        value: string | vscode.Uri | vscode.Location | unknown,
    ...
    const lm: typeof vscode.lm = {
      selectChatModels: (selector) => {
        if (initData.quality === "stable") {
          console.warn(
            `[${ExtensionIdentifier.toKey(extension.identifier)}] This API is disabled in '${initData.environment.appName}'-stable.`,
          )
    ...
    return <typeof vscode>{
      ...
      LanguageModelChatSystemMessage:
        extHostTypes.LanguageModelChatSystemMessage, // TODO@jrieken REMOVE
      ...
      LanguageModelChatAssistantMessage:
        extHostTypes.LanguageModelChatAssistantMessage, // TODO@jrieken REMOVE
