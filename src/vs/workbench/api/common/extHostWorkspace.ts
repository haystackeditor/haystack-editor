  ...
  private async _findFilesImpl(
    ...
    const fileQueries: IFileQueryBuilderOptions = {
      ...
      disregardSearchExcludeSettings:
        typeof options.useDefaultSearchExcludes === "boolean"
          ? !options.useDefaultSearchExcludes
          : false,
      maxResults: options.maxResults,
      excludePattern: excludePattern,
      shouldGlobSearch:
        typeof options.fuzzy === "boolean" ? !options.fuzzy : true,
    ...
    return this._proxy
      .$startFileSearch(folderToUse ?? null, fileQueries, token)
      .then((data) =>
