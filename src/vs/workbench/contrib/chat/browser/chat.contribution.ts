...
} from "vs/workbench/contrib/chat/browser/actions/chatCodeblockActions"
...
} from "vs/workbench/contrib/chat/common/languageModelStats"
import {
  IVoiceChatService,
  VoiceChatService,
      ...
      slashCommandService.registerSlashCommand(
        ...
        async (prompt, progress) => {
          ...
          if (defaultAgent?.metadata.helpTextVariablesPrefix) {
            ...
            if (
              isMarkdownString(defaultAgent.metadata.helpTextVariablesPrefix)
            ) {
              progress.report({
