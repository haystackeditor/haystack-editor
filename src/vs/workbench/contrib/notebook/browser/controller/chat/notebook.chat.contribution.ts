  ...
  implements IWorkbenchContribution
{
  ...
  constructor(
    ...
    private readonly _chatVariableService: IChatVariablesService,
    ...
    this._register(
      this._chatVariableService.registerVariable(
        {
        ...
        async (_message, _arg, model) => {
          ...
          for (const editor of editors) {
            const chatController = editor.getContribution(
              NotebookChatController.id,
            ) as NotebookChatController | undefined
