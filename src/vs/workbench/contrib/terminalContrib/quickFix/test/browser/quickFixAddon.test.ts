        ...
        test("command does not match", async () => {
          strictEqual(
            await getQuickFixesForCommand(
              [],
              terminal,
              createCommand(`gt add`, output, GitPullOutputRegex, exitCode),
              expectedMap,
              commandService,
              openerService,
              labelService,
        ...
        test("exit code does not match", async () => {
          strictEqual(
            await getQuickFixesForCommand(
              [],
              terminal,
              createCommand(command, output, GitPullOutputRegex, 2),
              expectedMap,
              commandService,
              openerService,
              labelService,
        ...
        test("matching exit status, command, ouput", async () => {
          assertMatchOptions(
            await getQuickFixesForCommand(
              [],
              terminal,
              createCommand(command, output, GitPullOutputRegex, exitCode),
              expectedMap,
              commandService,
              openerService,
              labelService,
