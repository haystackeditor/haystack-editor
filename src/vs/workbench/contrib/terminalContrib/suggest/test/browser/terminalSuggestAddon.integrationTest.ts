...
const recordedTestCases: { name: string; events: RecordedSessionEvent[] }[] = [
  {
    ...
    events: macos_bash_echo_simple as any as RecordedSessionEvent[],
  },
  {
    name: "macos_bash_echo_multiline",
    events: macos_bash_echo_multiline as any as RecordedSessionEvent[],
  },
  {
    name: "windows11_pwsh_getcontent_delete_ghost",
    events:
      windows11_pwsh_getcontent_delete_ghost as any as RecordedSessionEvent[],
  },
  {
    name: "windows11_pwsh_getcontent_file",
    events: windows11_pwsh_getcontent_file as any as RecordedSessionEvent[],
  },
  {
    name: "windows11_pwsh_input_ls_complete_ls",
    events:
      windows11_pwsh_input_ls_complete_ls as any as RecordedSessionEvent[],
  },
  {
    name: "windows11_pwsh_namespace_completion",
    events:
      windows11_pwsh_namespace_completion as any as RecordedSessionEvent[],
  },
  {
    name: "windows11_pwsh_type_before_prompt",
    events: windows11_pwsh_type_before_prompt as any as RecordedSessionEvent[],
  },
  {
    name: "windows11_pwsh_writehost_multiline_nav_up",
    events:
      windows11_pwsh_writehost_multiline_nav_up as any as RecordedSessionEvent[],
  },
  {
    name: "windows11_pwsh_writehost_multiline",
    events: windows11_pwsh_writehost_multiline as any as RecordedSessionEvent[],
  },
]
...
suite("Terminal Contrib Suggest Recordings", () => {
  ...
  for (const testCase of recordedTestCases) {
    test(testCase.name, async () => {
      ...
      store.add(
        suggestAddon.onAcceptedCompletion((e) => suggestDataEvents.push(e)),
      )
