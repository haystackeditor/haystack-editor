...
suite("InteractiveChatController", function () {
  ...
  setup(function () {
    const serviceCollection = new ServiceCollection(
      ...
      [
        ...
        new (class extends mock<IInlineChatSavingService>() {
  ...
  test("typing outside of wholeRange finishes session", async function () {
    ...
    assert.deepStrictEqual(
      ...
      new Range(1, 1, 1, 10 /* line length */),
    )
  ...
  test("escape doesn't remove code added from inline editor chat #3523 1/2", async function () {
    ...
    assert.strictEqual(
      contextKeyService.getContextKeyValue(CTX_INLINE_CHAT_USER_DID_EDIT.key),
      undefined,
    )
    ctrl.cancelSession()
    await r
