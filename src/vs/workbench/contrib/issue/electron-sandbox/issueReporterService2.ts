...
import {
  ...
  hide,
  show,
} from "vs/workbench/contrib/issue/browser/issue"
...
export class IssueReporter2 extends BaseIssueReporterService {
  constructor(
    ...
    super(
      configuration.disableExtensions,
      configuration.data,
      configuration.os,
  ...
  public updateExtensionSelector(
  ...
  public override removeLoading(
    element: HTMLElement,
    fromReporter: boolean = false,
  ) {
