...
} from "vs/workbench/services/editor/common/customEditorLabelService"
...
import { CodeEditorNode } from "vs/workbench/browser/haystack-frontend/editor/node"
...
export class TestHaystackService implements IHaystackService {
  ...
  createEditorElement(
    ...
    codeEditorNode?: CodeEditorNode | undefined,
    options?: IEditorOptions | undefined,
    args?: EditorOpenArgs | undefined,
