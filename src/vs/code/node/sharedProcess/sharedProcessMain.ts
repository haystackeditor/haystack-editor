...
import {
  ...
  getDisplayProtocol,
} from "vs/base/node/osDisplayProtocolInfo"
...
class SharedProcessMain extends Disposable implements IClientConnectionFilter {
  ...
  private async initServices(): Promise<IInstantiationService> {
    ...
    services.set(
      ...
      new SyncDescriptor(NativeUserDataProfileStorageService, undefined, true),
    )
    services.set(
      IUserDataSyncResourceProviderService,
  ...
  private reportProfilesInfo(
    ...
    telemetryService.publicLog2<ProfilesInfoEvent, ProfilesInfoClassification>(
      "profilesInfo",
      {
