...
suite("getFlows", () => {
  ...
  const testCases: Array<{
    ...
    {
      label: "Haystack Editor. Local filesystem. GitHub.com",
      query: {
        extensionHost: ExtensionHost.Local,
    ...
    {
      label: "Haystack Editor. Local filesystem. GitHub Hosted Enterprise",
      query: {
        extensionHost: ExtensionHost.Local,
        isSupportedClient: false,
        target: GitHubTarget.HostedEnterprise,
    ...
    {
      label: "Haystack Editor. Local filesystem. GitHub Enterprise Server",
      query: {
        extensionHost: ExtensionHost.Local,
        isSupportedClient: false,
        target: GitHubTarget.Enterprise,
