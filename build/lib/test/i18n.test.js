...
suite("XLF Parser Tests", () => {
    ...
    test("JSON file source path to Transifex resource match", () => {
        ...
        }, editorContrib = { name: "vs/editor/contrib", project: editorProject }, editor = { name: "vs/editor", project: editorProject }, base = { name: "vs/base", project: editorProject }, code = { name: "vs/code", project: workbenchProject }, workbenchParts = {
